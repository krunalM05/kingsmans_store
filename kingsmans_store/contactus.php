...
<html>
    <head>
        <title>Contact Us | Kingsman's Laptop Store</title>
	       ...
	       <div class="contact-info">
	           <h2 class="title">Contact Info</h2>
	               <address>
				    ...
				    <p>Email: info@kingsman'sStore.com</p>
	               </address>
	               
	            <div><h2 class="title">Follow Us On&#58;</h2>
                   <a href="#" target="_blank"><img src="./images/logofb.png" alt="fb logo" style="width:30px; height:30px; border:0"></a>
                   <a href="#" target="_blank"><img src="./images/logotwitter.png" alt="twitter logo" style="width:30px; height:30px; border:0; padding-left:10px;"></a>
               </div>
            </div>
        </div>
    </div>
